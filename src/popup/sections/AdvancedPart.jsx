  ...
  return (
    <>
      ...
      <label>
        ...
        <input
          type="text"
          value={config.imageInterpretationContext}
          onChange={(e) => {
            const value = e.target.value
            updateConfig({ imageInterpretationContext: value })
          }}
        />
      </label>
      <label>
      ...
      <label>
        <KnowledgeManager updateConfig={updateConfig} config={config}></KnowledgeManager>
      </label>
    </>
  )
}
